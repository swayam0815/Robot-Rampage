...
public class setInitialValues {
	...
	public setInitialValues(GraphicsConsole gc, int GRWIDTH, int GRHEIGHT) throws IOException {
		...
		guns[0] = new Gun(10, 100, 7, 0, 1, pistolImg, pistolFlipped, pistolSide, normalBullet, normalBulletBottom,
				true, true, "pistol", 10);
		// AR15
		guns[1] = new Gun(6, 200, 30, 1500, 1, AR15Img, AR15Flipped, AR15Side, normalBullet, normalBulletBottom, false,
				false, "AR15", 10);
		// sniper
		guns[2] = new Gun(30, 250, 10, 4000, 2, sniperImg, sniperFlipped, sniperSide, normalBullet, normalBulletBottom,
