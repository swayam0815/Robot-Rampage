...
public class setInitialValues {
	...
	public setInitialValues(GraphicsConsole gc, int GRWIDTH, int GRHEIGHT) throws IOException {
		...
		// pistol
		guns[0] = new Gun(10, 100, 7, 0, 0, pistolImg, pistolFlipped, pistolSide, normalBullet, normalBulletBottom,
				true, true, "pistol", 10);
		// AR15
		guns[1] = new Gun(6, 200, 30, 1500, 1, AR15Img, AR15Flipped, AR15Side, normalBullet, normalBulletBottom, false,
				false, "AR15", 10);
		// sniper
		guns[2] = new Gun(30, 250, 10, 4000, 0, sniperImg, sniperFlipped, sniperSide, normalBullet, normalBulletBottom,
				false, false, "sniper", 10);
		// minigun
		guns[3] = new Gun(3, 300, 100, 8500, 1, minigunImg, minigunFlipped, minigunSide, normalBullet, normalBulletBottom,
				false, false, "minigun", 10);
		// shotgun/grenade launcher
		guns[4] = new Gun(50, 170, 5, 12000, 0, grenadeLauncherImg, grenadeLauncherFlipped, grenadeLauncherSide,
				shotgunBullet, shotgunBulletBottom, false, false, "shotgun", 10);
		// water hose
		guns[5] = new Gun(2, 500, 1000, 20000, 1, hoseImg, hoseFlipped, hoseSide, waterDrop, waterDropBottom, false,
				false, "hose", 10);
